    ...
    try:
        ...
        if "CSM" in CSM_STATE:
            ...
            writeToFile.writelines(router + "," + "" + "," + " is managed by CSM " + "," + str(dateNow) + "\n")
             ...
             #task.run(netmiko_send_config,config_file="C:\\Users\\r1acer1b\\Desktop\\CONFIGS\\INTERNAL_ACL\\OBJECT_GROUPS.txt")
             #task.run(netmiko_send_config, config_file="C:\\Users\\r1acer1b\\Desktop\\CONFIGS\\INTERNAL_ACL\\INTERNAL_ACL.txt")
             for index in indexer:
                 ...
                 if ipaddr:
                     ...
                     for i in ipaddr:
                         ...
                         if "PROTECT_RTR_SW_ACL" in  inbound_acl or "PROTECT_ROUTERS_AND_SWITCHES" in inbound_acl:
                             print("An ACL is already applied  REMOVING " + interface + inbound_acl + outgoing_acl)
